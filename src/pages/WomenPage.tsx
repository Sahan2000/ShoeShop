...
export default function WomenPage() {
    const womenShoes = itemDB.filter((item: { gender: string }) => item.gender === "Women");
    return(
        <>
            <div className={"bg-[#f9f9f9] py-10"}>
                <div className={"flex sm:flex-row sm:justify-between sm:px-32 flex-col items-center justify-center px-5"}>
                    <h1 className={"font-jost font-semibold text-4xl"}>Women</h1>

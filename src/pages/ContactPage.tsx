                ...
                <div className="max-w-screen-xl mx-auto px-4 py-12 space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col space-y-4">
                            ...
                            <p className={"font-jost opacity-60"}>You can ask anything you want to know about our
                                products or services via this e-mail.</p>
                            <a href="mailto:helloshoeshop.lk"
                               className="font-jost opacity-60 underline">helloshoeshop.lk</a>
                            <a href="mailto:shoeshop.lkhelp@gmail.com"
                               className="underline font-jost opacity-60">shoeshop.lkhelp@gmail.com</a>
                        </div>
